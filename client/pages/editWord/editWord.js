        ...
        wx.login({
          success: function (res) {
            if (res.code) {
              ...
              console.log(that.data.oldAnswer+" is old name ")
              wx.request({
                url: 'https://chikeshi.applinzi.com/wechat/editWord.php',
                data: {
                  code: res.code,
